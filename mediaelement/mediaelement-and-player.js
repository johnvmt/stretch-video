	...
	initPlugin: function (id) {
		...
		if (pluginMediaElement) {
			...
			switch (pluginMediaElement.pluginType) {
				case "flash":
					pluginMediaElement.pluginElement = pluginMediaElement.pluginApi = rootDoc.getElementById(id);
					break;
				case "silverlight":
...
mejs.MediaElement = function (el, o, doc) {
...
mejs.HtmlMediaElementShim = {
	...
	create: function(el, o) {
		var
			...
			htmlMediaElement = (typeof(el) == 'string') ? rootDoc.getElementById(el) : el,
	...
	determinePlayback: function(htmlMediaElement, options, supportsMediaTag, isMediaTag, src) {
		...
		if (supportsMediaTag && (options.mode === 'auto' || options.mode === 'auto_plugin' || options.mode === 'native')  && !(mejs.MediaFeatures.isBustedNativeHTTPS && options.httpsBasicAuthSite === true)) {
			...
			if (!isMediaTag) {
				...
				dummy = rootDoc.createElement( result.isVideo ? 'video' : 'audio');
	...
	createErrorMessage: function(playback, options, poster) {
		var
			...
			errorContainer = rootDoc.createElement('div');
	...
	createPlugin:function(playback, options, poster, autoplay, preload, controls) {
		...
		if (playback.isVideo) {
				...
				rootDoc.body.insertBefore(container, rootDoc.body.childNodes[0]);
		}
...
'</object>';
			...
			case 'flash':
				...
				if (mejs.MediaFeatures.isIE) {
					specialIEContainer = rootDoc.createElement('div');
...
'</object>';
	...
	flashReady: function(id) {
		var
			...
			player = rootDoc.getElementById(id),
			pluginMediaElement = settings.pluginMediaElement;
